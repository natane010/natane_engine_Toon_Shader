// ===== NataneToon Shader - Screen Edge Split Variant =====
// Render Type: Opaque
// Queue: Geometry
// 特徴: Screen Edge を別パスへ逃がして Base pass の sampler 圧を下げる。
Shader "Natane/Toon Shader (ScreenEdge Split)"
{
    Properties
    {
        // ===== Base Settings (基本設定) =====
    ...
    SubShader
    {
        ...
        // Screen Edge Overlay Pass
        Pass
        {
            Name "SCREEN_EDGE_OVERLAY"
            Cull [_Cull]
            ZWrite Off
            ZTest LEqual
            ...
            #pragma hull hull
            #pragma domain domain
            #pragma fragment fragScreenEdgeOverlay
            #pragma multi_compile_fog
            #pragma multi_compile_instancing
            ...
            #include "../Include/Core/NataneToonTessellation.hlsl"
            #include "../Include/Rendering/NataneToonScreenEdgeOverlay.hlsl"
