// ===== NataneToon Shader - Transparent Variant =====
// Render Type: Transparent
// Queue: Transparent
// 特徴: 半透明レンダリング。アルファブレンディング対応。
Shader "Natane/Toon Shader (Transparent)"
{
    ...
    SubShader
    {
        ...
        // If you don't need these, use NataneToonShader_Transparent_Lite — no GrabPass, better perf.
        GrabPass
        {
...
#pragma shader_feature_local _EMISSION
    ...
    // "Transparent/Diffuse" FallBack could provide an opaque ShadowCaster,
    // causing shadow "bleeding" through transparent surfaces.
    FallBack Off
}
