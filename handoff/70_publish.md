# Natane Toon Shader v1.4.3 Publish Checklist

## Goal

Prepare and publish `com.natane.toonshader` version `1.4.3` to the VCC/VPM listing.

## Preconditions

- `package.json` version is `1.4.3`
...
6. Confirm the GitHub Release contains `com.natane.toonshader-1.4.3.zip`.
7. Confirm the VPM listing shows `1.4.3`:
   - `https://natanetoon.com/index.json`

## Expected Output

- GitHub Release: `v1.4.3`
- Release zip: `com.natane.toonshader-1.4.3.zip`
- Updated VPM listing entry for `1.4.3`
