...
namespace NataneToon.Editor
{
    ...
    /// VTuber最適化マテリアルプリセットジェネレーター
    /// VTuberキャラクターレンダリング用のプロフェッショナルプリセットを作成
    /// </summary>
    public static class VTuberPresetGenerator
    {
        private const string PRESET_PATH = "Assets/NataneToon/Runtime/Presets/VTuber/";

        [MenuItem("Tools/Natane/VTuberプリセット生成 Generate VTuber Presets", false, 50)]
        public static void GenerateAllPresets()
        {
            // Ensure directory exists / ディレクトリが存在することを確認
