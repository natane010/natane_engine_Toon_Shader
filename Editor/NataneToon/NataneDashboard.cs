...
namespace NataneToon.Editor
{
    ...
    public class NataneDashboard : EditorWindow
    {
        ...
        private void InitializeToolsList()
        {
            ...
            AddTool("テクスチャスタジオ", "Texture Studio", "スタンドアロンのペイントツールを起動します。ブラシ、レイヤー、フィルター、UV参照などの機能が使えます。", "Launch the standalone paint tool with brushes, layers, filters, and UV reference.", NataneToolMenuPaths.UVTextureGenerator, ToolCategory.Advanced, "🎭");
