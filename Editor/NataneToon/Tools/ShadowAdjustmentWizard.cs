...
namespace NataneToon.Editor
{
    ...
    public class ShadowAdjustmentWizard : EditorWindow
    {
        ...
        [MenuItem("Tools/Natane/Shadow Adjustment Wizard", false, 131)]
        public static void ShowWindow()
        {
            var window = GetWindow<ShadowAdjustmentWizard>("シャドウウィザード Shadow Wizard");
        ...
        private void DrawHeader()
        {
            ...
            EditorGUILayout.LabelField("シャドウ調整ウィザード Shadow Adjustment Wizard", EditorStyles.boldLabel);
            EditorGUILayout.LabelField("複数のシャドウパラメータを簡単に設定\nEasy setup for multiple shadow parameters", EditorStyles.miniLabel);
